	...
	<h1 id="headerTitle">SANGHAUI STREET ADMINISTRATOR</h1>
		<h1 id="title" >상품추가</h1>
				...
				<table id="prodDetails" class="table table-bordered">
					...
					<tr>
						<th>가격</th><td><input type="text"class="form-control" id="prod_price" name="prod_price" /></td>				
					</tr>
					<tr>
						<th>구분</th><td>TOP<input type="radio" name="prod_cat" value="상의"checked="checked"/><br/>
										BOTTOM<input type="radio" name="prod_cat" value="하의"/></td>				
					</tr>
			
					<tr>
						<th>상품설명</th><td><input type="text"class="form-control" id="prod_explain" name="prod_explain"  /></td>				
					</tr>
					<tr>
						<th>추가날짜</th><td><input type="text" readonly="readonly" name="prod_add_date" id="prod_add_date"placeholder="SYSDATE"></td>
					</tr>
					<tr>
						<th>삭제여부</th><td><input type="text" readonly="readonly" name="prod_delete" id="prod_delete" placeholder="N"/></td>
					</tr>
				</table>
